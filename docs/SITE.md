...
- `/` — Home page with hero (HL: "Turn online visibility into stronger response.", SH: "RAKA Marketing focuses on communication clarity, structure, and response — helping brands and creators make their message easier to understand, connect with, and act on."), **Services** (overview + **Communication Review & Strategy** card with focus areas), About / RAKA Marketing section, FAQs, and contact (Sydney with map pin).
